...
(function($){
            ...
            if(image_url != 'none'){
                ...
                if (bg_height > getWindowHeight()) {
                    if (window.innerWidth >= 769 && window.innerWidth <= 991) {
                        scree_fix_auto.css('height', topBarsHeight + 500);
                    } else {
                        scree_fix_auto.css('height', topBarsHeight + 32);
                    }
                }else{
                    scree_fix_auto.css('height', bg_height - totalTopBarsHeight + 200);
                }
            }else{
                scree_fix_auto.css('height', topBarsHeight);
            }
        }else{
            scree_fix_auto.css('height', 700);
        }
    }
    ...
    if(banner_slider.length > 0){
        banner_slider.owlCarousel({
            ...
            onInitialize: function (element) {
                banner_slider.children().sort(function () {
                    return Math.round(Math.random()) - 0.5;
                }).each(function () {
                    $(this).appendTo(banner_slider);
                });
            }
        });
    ...
    var agents_carousel = $("#agentscarousel");
