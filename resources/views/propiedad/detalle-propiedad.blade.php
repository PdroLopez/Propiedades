                ...
                <div class="col-md-9 col-sm-9">
                    <section id="property-detail">
                        <header class="property-title">
                            <h1>{{ $propiedad_find->direccion }}</h1>
                        ...
                        <section id="property-gallery">
                            <div class="owl-carousel property-carousel">
                                @foreach ($propiedad_img as $item)
                                    <div class="property-slide">
                                        <a href="assets/img/properties/property-detail-01.jpg" class="image-popup">
                                            <div class="overlay"><h3>Vista frontal
                                            </h3></div>

                                            <img src="{{ asset('storage/'.$item->ruta) }}" width="100%" height="auto">

                                        </a>
                                    </div>
                                @endforeach<!-- /.property-slide -->
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <section id="quick-summary" class="clearfix">
                                    <header><h2>Sumario rápido
                                    </h2></header>
                                    <dl>
                                        {{-- <dt>Location</dt>
                                            <dd>Chicago, IL 60610</dd> --}}
                                        <dt>Valor</dt>
                                            <dd><span class="tag price">${{number_format($propiedad_find->valor, 0, ',', '.')}}</span></dd>
                                        <dt>Tipo de Propiedad:</dt>
                                            <dd>{{ $propiedad_find->tipo->nombre }}</dd>
                                        <dt>Estado:</dt>
                                            <dd>{{ $propiedad_find->estado->nombre }}</dd>
                                        <dt>Metraje Construido:</dt>


                                            <dd>{{number_format($propiedad_find->metraje_construido, 0, ',', '.')}} m<sup>2</sup></dd>
                                        {{-- <dt>Beds:</dt>
                                            <dd>3</dd> --}}
                                        <dt>Piscina:</dt>
                                            <dd>{{ $propiedad_find->piscina }}</dd>
                                        {{-- <dt>Garages:</dt>
                                            <dd>2</dd> --}}
                                        {{-- <dt>Rating:</dt>
                            ...
                            <div class="col-md-8 col-sm-12">
                                <section id="description">
                                    <header><h2><b>Observación de la Propiedad</b></h2></header>
                                    <p>
                                       {{$propiedad_find->observacion}}
                                    </p>
                                ...
                                <section id="property-map">
                                    ...
                                    <div class="property-detail-map-wrapper">
                                        <div class="property-detail-map" id="property-detail-map"><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d13382.345139410278!2d-71.56051434999999!3d-33.0146812!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2scl!4v1612532045135!5m2!1ses!2scl" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
                                    </div>
