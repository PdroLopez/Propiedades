    ...
    <div id="slider" class="loading has-parallax">
        ...
        <div class="owl-carousel homepage-slider carousel-full-width">
            <div class="slide">
                ...
                <img alt="" src="{{ asset('assets/img/logos.jpg') }}" width="100%"  height="100%">
            </div>
            <div class="slide">
                <div class="container">
                    <div class="overlay">
    ...
    <div class="search-box-inner">
        <div class="container">
            <div class="search-box map">
                {!!Form::open(array('url' => '/buscar-propiedad', 'role'=>"form", 'id'=>"form-map-sale",'class'=>"form-map form-search clearfix",'method' => 'post','files' => 'true'))!!}
                 {{-- <div class="row">
                    <div class="col-md-2 col-sm-4">
                        <div class="form-group">
                            <label for="">Tipo de Propiedad</label>
                            {!! Form::select('tipo_propiedad', $tipo_propiedad, null, ['class'=>"form-control"]) !!}
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-4">
                        <div class="form-group">
                            <label for="">Dirección</label>
                            {!!Form::text('nombre',null,['class'=>"form-control", 'placeholder'=>"Ingrese una Dirección..."])!!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-4">
                        <div class="form-group">
                            ...
                            {!!Form::number('nombre',null,['class'=>"form-control", 'placeholder'=>"Ingrese un precio..."])!!}
                        </div>
                    </div>
                 ...
                 <div class="row">
                    <div class="col-md-2 col-sm-4">
                        <div class="form-group">
                            {!! Form::select('tipo_propiedad', $tipo_propiedad, null, ['class'=>"form-control",'placeholder'=>"Tipo de Propiedad..."]) !!}
                        </div><!-- /.form-group -->
                    </div>
                    {{-- <div class="col-md-2 col-sm-4">
                        <div class="form-group">
